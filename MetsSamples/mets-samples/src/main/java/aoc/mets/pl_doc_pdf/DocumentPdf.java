...
public class DocumentPdf {
	...
	public static void main(String[] args) throws MetsException, Exception {
		...
		String pathThisSample = ("aoc/mets/pl_doc_pdf/").replaceAll("/", fileSeparator);
		...
		String documentName     = "test_signed.pdf";
		...
		String zipFilePath = pathOutDir + "PIT_document_pdf.zip";
