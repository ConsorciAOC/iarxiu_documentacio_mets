package aoc.mets.pl_expedient_multi_cades_detached;
...
/**
 * Classe encarregada de crear un METS d'expedient amb 2 documents XML i la seva respectiva signatura CAdES-T detached.
 ...
 *
 */
public class ExpedientMultiCadesDetached {
	...
	public static void main(String[] args) throws MetsException, Exception {
		...
		String pathThisSample = ("aoc/mets/pl_expedient_multi_cades_detached/").replaceAll("/", fileSeparator);
		...
		if (rootExpedientsFolder.isDirectory()) {
			...
			for (File expedientFolder : expedientsFolders) {
				...
				if (expedientFolder.isDirectory()) {
					...
					String documentFilename =  "doc" + folderPattern + "_11MB.doc";
					String signatureFilename = "doc" + folderPattern + "_11MB.doc_cades_detached.p7s";
			...
			String zipFilePath = pathOutDir + "PIT_expedient_multi_CAdES_detached.zip";
