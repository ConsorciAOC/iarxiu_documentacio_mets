package aoc.mets.pl_doc_xades_detached;
 ...
 */
public class DocumentXadesDetached {
	...
	public static void main(String[] args) throws MetsException, Exception {
		...
		String pathThisSample = ("aoc/mets/pl_doc_xades_detached/").replaceAll("/", fileSeparator);
		...
		String zipFilePath = pathOutDir + "PIT_document_XAdES_detached.zip";
