...
6. Desde dicha consola del sistema, se ejecutan los siguientes comandos, situándose antes en el directorio 
	...
	mvn org.apache.maven.plugins:maven-install-plugin:2.5.2:install-file -Dfile=mets-schema-5.2.0.jar
	mvn org.apache.maven.plugins:maven-install-plugin:2.5.2:install-file -Dfile=xmlschema-validator-5.2.0.jar
...
8. Desde dicha consola del sistema, se ejecuta el siguiente comando, situándose antes en el directorio 
	...
	mvn org.apache.maven.plugins:maven-install-plugin:2.5.2:install-file -Dfile=xlink-schema-5.2.0.jar
